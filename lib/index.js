...
const defaultOption = {
    ...
    super: '&#174;',
    isShowExtend: true,
    extendContent: '<a href="https://beian.miit.gov.cn/" target="_blank">粤ICP备XXXXXXXX号</a>'
};
    ...
    hooks: {
        'page:before': function (page) {
            ...
            if (this.output.name === 'website') {
                page.content = page.content + generate(this.config.get('pluginsConfig')['page-footer-extend']);
            }
